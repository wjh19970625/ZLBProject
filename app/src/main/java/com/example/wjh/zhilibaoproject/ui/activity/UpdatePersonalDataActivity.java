...
import com.example.wjh.zhilibaoproject.utils.BitmapUtil;
        ...
        switch (requestCode){
            case REQUEST_PICK_IMG:
                if (data != null){
                    ...
                    try {
                        bitmap= BitmapUtil.getUriBitmap(UpdatePersonalDataActivity.this,uri, Config.STORAGE_PATH,Config.UPLOAD_IMAGE_NAME,800,400);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
